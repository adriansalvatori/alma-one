  ...
  return {
    ...
    data: function () {
      return {
        ...
        strings: {
          ...
          blockID: __('Unique ID', 'uipress-lite'),
    ...
    watch: {
      componenetSettings: {
        handler(newValue, oldValue) {
          let self = this;
          if (!self.loading && self.formattedOptions) {
      ...
      'block.settings.style.options.dimensions.value': {
        handler(newValue, oldValue) {
          ...
          this.uipress.createNestedObject(this.componenetSettings, ['style', 'options', 'dimensions', 'value', 'width']);
          this.uipress.createNestedObject(this.componenetSettings, ['style', 'options', 'dimensions', 'value', 'height']);

          if (JSON.stringify(newValue.width) != JSON.stringify(this.componenetSettings.style.options.dimensions.value.width)) {
            if (this.uipress.checkNestedValue(newValue, ['width', 'value'])) {
              this.componenetSettings.style.options.dimensions.value.width = {
                value: newValue.width.value,
                units: newValue.width.units,
              };
              this.componenetSettings.style.options.dimensions.loading = true;
            }
          }

          if (JSON.stringify(newValue.height) != JSON.stringify(this.componenetSettings.style.options.dimensions.value.height)) {
            if (this.uipress.checkNestedValue(newValue, ['height', 'value'])) {
              this.componenetSettings.style.options.dimensions.value.height = {
                value: newValue.height.value,
                units: newValue.height.units,
              };
              this.componenetSettings.style.options.dimensions.loading = true;
            }
          }
          ...
          requestAnimationFrame(() => {
            this.componenetSettings.style.options.dimensions.loading = false;
          });
        },
        deep: true,
      },
    ...
    template: `
        ...
        <div v-if="buildingSettings" class="uip-text-muted uip-text-center">{{strings.buildingSettings}}</div>
          ...
          <div class="uip-padding-s uip-padding-top-remove uip-overflow-auto uip-scrollbar">
              ...
              <div class=" uip-flex uip-flex-column uip-gap-s">
                ...
                <div class="uip-padding-s uip-padding-right-remove">
                  ...
                  <div class="uip-grid-col-1-3">
                      ...
                      <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.name}}</span></div>
                      <input class="uip-input uip-input-small" type="text" v-model="block.name">
                    
                      <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.blockID}}</span></div>
                      ...
                      <div class="uip-text-muted uip-flex uip-flex-center uip-max-h-30"><span>{{strings.link}}</span></div>
                ...
                <div class="" >
                  ...
                  <div class="uip-padding-s uip-padding-right-remove uip-flex uip-flex-column uip-row-gap-xs" v-if="uiTemplate.proActivated">
                    ...
                    <div class="uip-grid-col-1-3">
                      ...
                      <div class="uip-text-muted uip-flex uip-flex-center"><span>{{strings.query}}</span></div>
            ...
            <div class="uip-flex uip-flex-column uip-row-gap-s uip-margin-bottom-l" v-if="section == 'style'">
              ...
              <drop-down dropPos="left" triggerClass="uip-w-100p uip-border-box" v-if="returnBlockPartsCount > 0" class="uip-position-sticky uip-top-0" style="z-index:2">
                ...
                <template v-slot:content> 
                  ...
                  <div class="uip-padding-xs uip-flex uip-flex-column uip-min-w-300">
                ...
                <template v-for="option in returnCompSettings.options">
                  ...
                  <div class="">
                    ...
                    <div class="uip-margin-bottom-xxs uip-flex uip-flex-center uip-flex-between">
                       ...
                       <drop-down dropPos="left" triggerClass="uip-flex uip-gap-xxxs uip-flex-center">
                        <template v-slot:trigger>
                    ...
                    <div class="uip-padding-s uip-padding-right-remove">
                      ...
                      <template v-else-if="!option.activePseudo || option.activePseudo == 'none'">
                       ...
                       :blockSettings="block.settings"></component>
                  ...
                  <div class="uip-padding-s uip-padding-right-remove">
                    ...
                    <div class="uip-grid-col-1-3">
                      ...
                      <div class="uip-flex uip-flex-center uip-gap-xxs">
                        ...
                        <drop-down dropPos="left" containerClass="uip-w-100p" triggerClass="uip-w-100p">
        ...
        <div v-if="missing" class="uip-padding-s">
          <div class="uip-background-orange-wash uip-padding-xs uip-border-rounder uip-margin-bottom-s">{{strings.missingMessage}}</div>
